...
MODEL_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "grok": {
        ...
        "call": "subscribe",
        "doc_url": "https://fal.ai/models/xai/grok-imagine-image/api",
        "options": {
            "prompt": {
                "type": "prompt",
                "default": None,
    ...
    "grok-edit": {
        ...
        "call": "subscribe",
        "doc_url": "https://fal.ai/models/xai/grok-imagine-image/edit/api",
        "options": {
            "prompt": {
                "type": "prompt",
                "default": None,
            ...
            "image_urls": {
                "type": str,
                "default": None,
                "help": "image URL input (repeatable, max 3)",
                "action": "append",
                "metavar": "URL",
                "flags": ["--image-url", "--image-urls", "-u"],
            },
